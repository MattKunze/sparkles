// taken from https://github.com/mlrawlings/context-require/blob/master/src/index.ts
// adapted to support sharing cache across require instances
...
export class ContextModule extends Module {
   ...
   */
  constructor({ dir, context, resolve, extensions, cache }: Types.Options) {
 ...
 * @param filename
 */
function protoLoad(filename: string) {
